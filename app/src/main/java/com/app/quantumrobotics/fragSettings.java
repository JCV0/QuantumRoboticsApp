...
public class fragSettings extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ListView lV= vista.findViewById(R.id.listview);
        List<String> lista= new ArrayList<>();
        lista.add("Cam");
        lista.add("Controls settings");
        lista.add("Preferences");
        lista.add("Version: 1.0");

        ArrayAdapter arrayAdapter= new ArrayAdapter(getContext(), android.R.layout.simple_list_item_1,lista);
